        ...
        while 1:
            ...
            def on_report(self):
                ...
                for trans in transactions:
                    contents.replace('8004', transactions[trans]['time'])
                    contents.replace('buy', transactions[trans]['type'])
                    contents.replace('120', transactions[trans]['price'])
                    contents.replace('Manager1', transactions[trans]['manager'])
                    contents.replace('EMA', transactions[trans]['strategy'])
